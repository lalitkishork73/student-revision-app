...
export default function Dashboard () {
    const { data, loading, error, subject, type, fromDate, toDate, setFilters, fetchDashboard } = useDashboardStore();
            ...
            <Card className="shadow-sm border-border">
                <CardContent className="p-4 flex flex-col md:flex-row md:items-end gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <Select value={type} onValueChange={(val) => setFilters({ type: val })}>
                            <SelectTrigger>
